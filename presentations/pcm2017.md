...
- When we deploy a project, all required repos get cloned into a dedicated project-specific folder
- We avoid using a global shared folder in production since this way we can reference different versions of it by project
