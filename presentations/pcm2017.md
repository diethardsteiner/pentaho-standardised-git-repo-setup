...
Title Note    : Not for distribution - Still working progress
...
| folder                             | description
|------------------------------------|---------------------------------
| `pdi`                              | pdi files (ktr, kjb). Also root of file based repo if used.
...
- In developement, do not nest your root folder to deep (e.g `/home/pentaho/projectX` VS `projectX`)
...
Special thanks to Luis for suggesting Git Hooks and providing some of the hooks.
...
- Referenced **database connections** are part of a spefied list (also not empty)
...
![structure-without-common-artefacts] 
 
[structure-without-common-artefacts]: pics/structure-without-common-artefacts.png "Structure without common artefacts" { width: 800px }
...
![Picture: Structure with common artefacts][structure-with-common-artefacts] 
 
[structure-with-common-artefacts]: pics/structure-with-common-artefacts.png width=800px

## Spoon Pre-Configured

- Important settings enforced out-of-the-box:

![Picture: Spoon Preconfigured][spoon-preconfigured] 
 
[spoon-preconfigured]: pics/spoon-preconfigured.png width=800px
...
![Picture: PDI Repo Access Pre-Configured][modules-shown-in-repo-browser] 
 
[modules-shown-in-repo-browser]: pics/modules-shown-in-repo-browser.png width=800px

## PDI Reusable Code: Modules

- Modules reside in a **separate repository**
- They are referenced from within each `code` repository
...
![Picture: Pre-Commit Validation][pre-commit-validation] 
 
[pre-commit-validation]: pics/pre-commit-validation.png width=800px
