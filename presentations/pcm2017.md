...
![structure-with-common-artefacts] 
 
[structure-with-common-artefacts]: pics/structure-with-common-artefacts.png "Structure with common artefacts" { width: 800px }
...
[spoon-preconfigured]: pics/spoon-preconfigured.png "Spoon Preconfigured" { width: 800px }
...
![modules-shown-in-repo-browser] 
 
[modules-shown-in-repo-browser]: pics/modules-shown-in-repo-browser.png "PDI Repo Access Pre-Configured" { width: 800px }
...
[pre-commit-validation]: pics/pre-commit-validation.png "Pre-Commit Validation" { width: 800px }
