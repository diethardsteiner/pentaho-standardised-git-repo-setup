...
- In developement, so not nest your root folder to deep (e.g `/home/pentaho/projectX` VS `projectX`)
...
- File or folder names do not contain `test`, `beta`, `v[0-9]{1}`
...
## Exmaple: Merge Request on GitLab
